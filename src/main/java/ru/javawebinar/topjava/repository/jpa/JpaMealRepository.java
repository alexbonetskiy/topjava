...
public class JpaMealRepository implements MealRepository {
    ...
    public Meal get(int id, int userId) {
        ...
        catch (NoResultException e) {throw new NotFoundException("Такой еды в базе нет");}
        }
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return em.createNamedQuery(Meal.GET_BETWEEN, Meal.class).setParameter("userId", userId).setParameter("startDateTime", startDateTime).setParameter("endDateTime", endDateTime).getResultList();
    }
}